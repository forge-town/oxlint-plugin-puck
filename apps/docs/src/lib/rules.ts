...
export const rules = [
  {
    ...
    title: "原子组件模块",
    plugin: "template-component",
    pluginKey: "template-component/atomic-component",
...
export const Button = ({ children }: ButtonProps) => <button>{children}</button>;`,
  ...
  },
  {
    ...
    pluginKey: "template-schema/atomic-schema",
...
export const UserSchema = z.object({ name: z.string() });`,
  ...
  },
  {
    ...
    title: "JSX 属性排序",
    plugin: "template",
    pluginKey: "template/jsx-sort-props",
  ...
  },
  {
    ...
    title: "return 前空行",
    plugin: "template-return",
    pluginKey: "template-return/newline-before-return",
  ...
  },
  {
    ...
    plugin: "template-store",
    pluginKey: "template-store/no-component-handlers",
  ...
  },
  {
    ...
    plugin: "template-store",
    pluginKey: "template-store/no-handle-return-function",
...
<button onClick={handleItem.bind(null, "1")}>Delete</button>;`,
  ...
  },
  {
    ...
    pluginKey: "template-types/no-explicit-unknown",
...
const parse = (input: Data) => input;`,
  ...
  },
  {
    ...
    plugin: "template-handle-call",
    pluginKey: "template-handle-call/no-handle-calls-handle",
  ...
  },
  {
    ...
    plugin: "template-on-call",
    pluginKey: "template-on-call/no-handle-calls-on",
  ...
  },
  {
    ...
    pluginKey: "template-vars/no-let",
...
count = 1;`,
  ...
  },
  {
    ...
    plugin: "template-env",
    pluginKey: "template-env/no-process-env-outside-integration",
...
export const apiUrl = process.env.API_URL;`,
  ...
  },
  {
    ...
    pluginKey: "template-error/no-try",
...
const result = Result.fromThrowable(risky)();`,
  ...
  },
  {
    ...
    plugin: "template-effect",
    pluginKey: "template-effect/no-use-effect",
...
<button onClick={handleMount}>Start</button>;`,
  ...
  },
  {
    ...
    plugin: "template-refine",
    pluginKey: "template-refine/no-use-list-data-fallback",
...
return <PostList items={data} />;`,
  ...
  },
  {
    ...
    plugin: "template-jsx-callback",
    pluginKey: "template-jsx-callback/strict-jsx-callback-handler",
  ...
  },
  {
    ...
    plugin: "template-handler-verb",
    pluginKey: "template-handler-verb/strict-jsx-handler-verb",
  ...
  },
  {
    ...
    pluginKey: "template-method/strict-method-module",
    description:
